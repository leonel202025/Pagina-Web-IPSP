      ...
      <div className={`modal-box ${tipo}`}>
        <div className="modal-icon">
          ...
          {tipo === "advertencia" && (
            ...
            >
              <circle className="circle" cx={26} cy={26} r={23.5} fill="none" />
              <path className="exclamation-line" d="M26 15v14" fill="none" />
          ...
          {tipo === "confirmacion" && (
            ...
            >
              <circle className="circle" cx={26} cy={26} r={23.5} fill="none" />
              <path className="exclamation-line" d="M26 16v12" fill="none" />
              <circle className="exclamation-dot" cx={26} cy={36} r={2.5} />
            </svg>
          )}
        </div>
        ...
        {tipo === "confirmacion" ? (
          ...
          <div className="modal-buttons">
            <button className="modal-btn confirmar" onClick={onVolverAlPanel}>
